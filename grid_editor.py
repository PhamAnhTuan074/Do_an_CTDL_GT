...
# # def save_to_file():
# #     # Đảo ngược thứ tự các hàng của ma trận để phù hợp với lưới tọa độ
# #     flipped_env = np.flipud(env)
# #     np.savetxt("grid_matrix.txt", flipped_env, fmt='%d')
# #     print("Matrix saved to grid_matrix.txt (flipped to match grid coordinates)")

# def save_to_file():
#     """
#     Lưu ma trận vào file grid_matrix.txt, bao gồm kích thước n, m ở dòng đầu tiên.
#     """
#     flipped_env = np.flipud(env)  # Đảo ngược thứ tự các hàng để phù hợp với lưới tọa độ
#     with open("grid_matrix.txt", "w") as file:
#         # Ghi kích thước n, m vào dòng đầu tiên
#         file.write(f"{n} {m}\n")
#         # Ghi ma trận vào file
#         for row in flipped_env:
#             file.write(" ".join(map(str, row)) + "\n")
#     print("Matrix and dimensions saved to grid_matrix.txt (flipped to match grid coordinates)")
# # Initial plot
# update_plot()
